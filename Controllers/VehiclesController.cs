...
namespace DesertStorm.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="VehicleID,ShortDescription")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="VehicleID,ShortDescription")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
